...
Template.result.helpers({
  'getResult': function(){
    if(Session.get("SearchByTask")){
      ...
      return taskDetail.find({from: {$gte: searchFrom},to:{$lte: searchTo}, hours :{$gte: searchByHours,$lte: range1}, date : new Date(searchByDate), course: SearchByCourse, classes: searchByClass}).fetch();
    }
      ...
      searchArr1[0] =Number(searchArr1[0]) + 1;
      var range1= searchArr[0]+ ":" + "00";
      return taskDetail.find({from: {$gte: searchFrom},to:{$lte: searchTo}, hours :{$gte: searchByHours,$lte: range1}, date : new Date(searchByDate), classes: searchByClass}).fetch();
    }
      ...
      return taskDetail.find({from: {$gte: searchFrom},to:{$lte: searchTo}, date : new Date(searchByDate), course: SearchByCourse, classes: searchByClass}).fetch();
    }
      ...
      searchArr1[0] =Number(searchArr1[0]) + 1;
      var range1= searchArr[0]+ ":" + "00";
      return taskDetail.find({from: {$gte: searchFrom},to:{$lte: searchTo}, hours :{$gte: searchByHours,$lte: range1}, course: SearchByCourse, classes: searchByClass}).fetch();
    }
      ...
      searchArr1[0] =Number(searchArr1[0]) + 1;
      var range1= searchArr[0]+ ":" + "00";
      return taskDetail.find({from :{$gte: searchFrom,$lte: range}, date : new Date(searchByDate), hours :{$gte: searchByHours,$lte: range1}, course: SearchByCourse, classes: searchByClass}).fetch();
    }
      ...
      searchArr1[0] =Number(searchArr1[0]) + 1;
      var range1= searchArr[0]+ ":" + "00";
      return taskDetail.find({to :{$gte: searchTo,$lte: range}, date : new Date(searchByDate), hours :{$gte: searchByHours,$lte: range1}, course: SearchByCourse, classes: searchByClass}).fetch();
    }
      ...
      searchArr1[0] =Number(searchArr1[0]) + 1;
      var range1= searchArr[0]+ ":" + "00";
      return taskDetail.find({from: {$gte: searchFrom},to:{$lte: searchTo}, hours :{$gte: searchByHours,$lte: range1}, date : new Date(searchByDate), course: SearchByCourse}).fetch();
    }
      ...
      searchArr1[0] =Number(searchArr1[0]) + 1;
      var range1= searchArr[0]+ ":" + "00";
      return taskDetail.find({from: {$gte: searchFrom},to:{$lte: searchTo}, hours :{$gte: searchByHours,$lte: range1}, date : new Date(searchByDate)}).fetch();
    }
      ...
      var searchByClass= Session.get("SearchByClass");
      console.log("searchby time");
      return taskDetail.find({from: {$gte: searchFrom},to:{$lte: searchTo}, date : new Date(searchByDate), classes: searchByClass}).fetch();
    }
      ...
      var SearchByCourse= Session.get("SearchByCourse");
      console.log("searchby time");
      return taskDetail.find({from: {$gte: searchFrom},to:{$lte: searchTo}, date : new Date(searchByDate), course: SearchByCourse}).fetch();
    }
      ...
      searchArr1[0] =Number(searchArr1[0]) + 1;
      var range1= searchArr[0]+ ":" + "00";
      return taskDetail.find({from: {$gte: searchFrom},to:{$lte: searchTo}, hours :{$gte: searchByHours,$lte: range1}, course: SearchByCourse}).fetch();
    }
      ...
      searchArr1[0] =Number(searchArr1[0]) + 1;
      var range1= searchArr[0]+ ":" + "00";
      return taskDetail.find({from: {$gte: searchFrom},to:{$lte: searchTo}, hours :{$gte: searchByHours,$lte: range1}, classes: SearchByClass}).fetch();
    }
      ...
      var SearchByCourse= Session.get("SearchByCourse");
      console.log("searchby time");
      return taskDetail.find({from: {$gte: searchFrom},to:{$lte: searchTo}, classes: searchByClass, course: SearchByCourse}).fetch();
    }
      ...
      searchArr1[0] =Number(searchArr1[0]) + 1;
      var range1= searchArr[0]+ ":" + "00";
      return taskDetail.find({from :{$gte: searchFrom,$lte: range}, course: SearchByCourse, hours :{$gte: searchByHours,$lte: range1}, classes: SearchByClass}).fetch();
    }
      ...
      searchArr1[0] =Number(searchArr1[0]) + 1;
      var range1= searchArr[0]+ ":" + "00";
      return taskDetail.find({to :{$gte: searchTo,$lte: range}, date : new Date(searchByDate), hours :{$gte: searchByHours,$lte: range1}, classes: SearchByClass}).fetch();
    }
      ...
      searchArr1[0] =Number(searchArr1[0]) + 1;
      var range1= searchArr[0]+ ":" + "00";
      return taskDetail.find({from :{$gte: searchFrom,$lte: range}, date : new Date(searchByDate), hours :{$gte: searchByHours,$lte: range1}, classes: SearchByClass}).fetch();
    }
      ...
      searchArr1[0] =Number(searchArr1[0]) + 1;
      var range1= searchArr[0]+ ":" + "00";
      return taskDetail.find({from :{$gte: searchFrom,$lte: range}, date : new Date(searchByDate), hours :{$gte: searchByHours,$lte: range1}, course: SearchByCourse}).fetch();
    }
      ...
      searchArr[0] =Number(searchArr[0]) + 1;
      var range= searchArr[0]+ ":" + "00";
      return taskDetail.find({from :{$gte: searchFrom,$lte: range}, date : new Date(searchByDate), classes: searchByClass, course: SearchByCourse}).fetch();
    }
      ...
      searchArr[0] =Number(searchArr[0]) + 1;
      var range= searchArr[0]+ ":" + "00";
      return taskDetail.find({to :{$gte: searchTo,$lte: range}, date : new Date(searchByDate), classes: searchByClass, course: SearchByCourse}).fetch();
    }
      ...
      searchArr1[0] =Number(searchArr1[0]) + 1;
      var range1= searchArr[0]+ ":" + "00";
      return taskDetail.find({to :{$gte: searchTo,$lte: range}, hours :{$gte: searchByHours,$lte: range1}, classes: searchByClass, course: SearchByCourse}).fetch();
    }
      ...
      searchArr1[0] =Number(searchArr1[0]) + 1;
      var range1= searchArr[0]+ ":" + "00";
      return taskDetail.find({hours: searchHours, date : new Date(searchByDate), classes: searchByClass, course: SearchByCourse}).fetch();
    }
      ...
      searchArr1[0] =Number(searchArr1[0]) + 1;
      var range1= searchArr[0]+ ":" + "00";
      return taskDetail.find({to :{$gte: searchTo,$lte: range}, date : new Date(searchByDate), hours :{$gte: searchByHours,$lte: range1}, course: SearchByCourse}).fetch();
    }
      ...
      var searchByDate= Session.get("SearchByDate");
      console.log("searchby time");
      return taskDetail.find({from: {$gte: searchFrom},to:{$lte: searchTo}, date : new Date(searchByDate)}).fetch();
    }
      ...
      var SearchByCourse= Session.get("SearchByCourse");
      console.log("searchby time");
      return taskDetail.find({from: {$gte: searchFrom},to:{$lte: searchTo}, course: SearchByCourse}).fetch();
    }
      ...
      var searchByClass= Session.get("SearchByClass");
      console.log("searchby time");
      return taskDetail.find({from: {$gte: searchFrom},to:{$lte: searchTo}, classes: searchByClass}).fetch();
    }
      ...
      searchArr1[0] =Number(searchArr1[0]) + 1;
      var range1= searchArr[0]+ ":" + "00";
      return taskDetail.find({from: {$gte: searchFrom},to:{$lte: searchTo}, hours :{$gte: searchByHours,$lte: range1}}).fetch();
    }
      ...
      searchArr[0] =Number(searchArr[0]) + 1;
      var range= searchArr[0]+ ":" + "00";
      return taskDetail.find({from :{$gte: searchFrom,$lte: range}, date : new Date(searchByDate), course: SearchByCourse}).fetch();
    }
      ...
      searchArr[0] =Number(searchArr[0]) + 1;
      var range= searchArr[0]+ ":" + "00";
      return taskDetail.find({from :{$gte: searchFrom,$lte: range}, date : new Date(searchByDate), classes: searchByClass}).fetch();
    }
      ...
      searchArr1[0] =Number(searchArr1[0]) + 1;
      var range1= searchArr[0]+ ":" + "00";
      return taskDetail.find({from :{$gte: searchFrom,$lte: range}, date : new Date(searchByDate), hours :{$gte: searchByHours,$lte: range1}}).fetch();
    }
      ...
      searchArr1[0] =Number(searchArr1[0]) + 1;
      var range1= searchArr[0]+ ":" + "00";
      return taskDetail.find({from :{$gte: searchFrom,$lte: range}, course: SearchByCourse, hours :{$gte: searchByHours,$lte: range1}}).fetch();
    }
      ...
      searchArr[0] =Number(searchArr[0]) + 1;
      var range= searchArr[0]+ ":" + "00";
      return taskDetail.find({from :{$gte: searchFrom,$lte: range}, course: SearchByCourse, classes: searchByClass}).fetch();
    }
      ...
      searchArr1[0] =Number(searchArr1[0]) + 1;
      var range1= searchArr[0]+ ":" + "00";
      return taskDetail.find({from :{$gte: searchFrom,$lte: range}, classes: searchByClass, hours :{$gte: searchByHours,$lte: range1}}).fetch();
    }
      ...
      searchArr[0] =Number(searchArr[0]) + 1;
      var range= searchArr[0]+ ":" + "00";
      return taskDetail.find({to :{$gte: searchTo,$lte: range}, date : new Date(searchByDate), classes: searchByClass}).fetch();
    }
      ...
      searchArr[0] =Number(searchArr[0]) + 1;
      var range= searchArr[0]+ ":" + "00";
      return taskDetail.find({to :{$gte: searchTo,$lte: range}, date : new Date(searchByDate), course: SearchByCourse}).fetch();
    }
      ...
      searchArr1[0] =Number(searchArr1[0]) + 1;
      var range1= searchArr[0]+ ":" + "00";
      return taskDetail.find({to :{$gte: searchTo,$lte: range}, date : new Date(searchByDate), hours :{$gte: searchByHours,$lte: range1}}).fetch();
    }
      ...
      searchArr[0] =Number(searchArr[0]) + 1;
      var range= searchArr[0]+ ":" + "00";
      return taskDetail.find({to :{$gte: searchTo,$lte: range}, classes: searchByClass, course: SearchByCourse}).fetch();
    }
      ...
      searchArr1[0] =Number(searchArr1[0]) + 1;
      var range1= searchArr[0]+ ":" + "00";
      return taskDetail.find({to :{$gte: searchTo,$lte: range}, hours :{$gte: searchByHours,$lte: range1}, course: SearchByCourse}).fetch();
    }
      ...
      searchArr1[0] =Number(searchArr1[0]) + 1;
      var range1= searchArr[0]+ ":" + "00";
      return taskDetail.find({to :{$gte: searchTo,$lte: range}, hours :{$gte: searchByHours,$lte: range1}, classes: searchByClass}).fetch();
    }
      ...
      searchArr1[0] =Number(searchArr1[0]) + 1;
      var range1= searchArr[0]+ ":" + "00";
      return taskDetail.find({hours: searchHours, date : new Date(searchByDate), course: SearchByCourse}).fetch();
    }
      ...
      searchArr1[0] =Number(searchArr1[0]) + 1;
      var range1= searchArr[0]+ ":" + "00";
      return taskDetail.find({hours: searchHours, date : new Date(searchByDate), classes: searchByClass}).fetch();
    }
      ...
      var searchByDate= Session.get("SearchByDate");
      var SearchByCourse= Session.get("SearchByCourse");
      return taskDetail.find({classes: searchClass, date : new Date(searchByDate), course: SearchByCourse}).fetch();
    }
      ...
      searchArr1[0] =Number(searchArr1[0]) + 1;
      var range1= searchArr[0]+ ":" + "00";
      return taskDetail.find({classes: searchClass, hours :{$gte: searchByHours,$lte: range1}, course: SearchByCourse}).fetch();
    }
...
Template.result.events({
  ...
  'input .commonFromTo':function(event, tmpl){
    event.preventDefault();
    console.log("from-to");
